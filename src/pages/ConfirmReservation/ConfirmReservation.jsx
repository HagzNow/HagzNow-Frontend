    ...
    <>
      ...
      <style>{`
        @media print {
          ...
          * {
          ...
          .bg-gradient-to-r,
          .bg-gradient-to-br {
            background:rgb(40, 82, 68) !important;
            -webkit-print-color-adjust: exact;
            print-color-adjust: exact;
            color-adjust: exact;
          }
          
          /* Make invoice card full width for print */
          .container {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50/30 dark:from-gray-900 dark:to-gray-800 py-8 print:bg-white transition-colors duration-300">
        <div className="container mx-auto px-4 max-w-4xl">
          {/* Success Header */}
          <div className="text-center mb-8 success-header print:hidden">
          ...
          {/* Footer Note */}
          <div className="text-center mt-8 text-gray-500 dark:text-gray-400 text-sm footer-note print:hidden">
