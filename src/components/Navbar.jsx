...
const Navbar = () => {
    ...
    <nav className="bg-green-700 text-white py-3 px-6 shadow-md">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center justify-center lg:justify-start gap-8 w-full lg:w-auto">
          {/* اللوجو */}
          <span className="text-2xl font-bold whitespace-nowrap">ArenaBook</span>
  ...
  <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 lg:ml-14">
    <span className="hover:underline cursor-pointer whitespace-nowrap">تواصل معنا</span>
    <span className="hover:underline cursor-pointer whitespace-nowrap">عن المنصة</span>
    <span className="hover:underline cursor-pointer whitespace-nowrap">الملاعب الرئيسية</span>
    <span className="hover:underline cursor-pointer whitespace-nowrap">المساعدة</span>
  </div>
</div>
