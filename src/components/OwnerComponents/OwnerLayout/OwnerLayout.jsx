...
export default function OwnerLayout() {
  ...
  return (
    <>
      ...
      {/* Main layout wrapper */}
      <div className="flex flex-row-reverse min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-300" dir={isRTL ? 'rtl' : 'ltr'}>
        {/* Sidebar Desktop */}
        <aside
          className={`hidden md:block fixed top-16 ${
            isRTL ? 'right-0' : 'left-0'
          } h-[calc(100vh-4rem)] w-74 border-l border-neutral-200 dark:border-gray-700 bg-white dark:bg-gray-800 transition-colors duration-300 z-40`}
        >
          <Sidebar
            mode="admin"
            menuItems={menu}
