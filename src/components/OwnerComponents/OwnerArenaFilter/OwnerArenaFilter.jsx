...
export default function OwnerArenaFilter({ onFilterChange }) {
    ...
    return (
        <div dir="rtl" className="w-full bg-white dark:bg-gray-800 shadow-sm dark:shadow-gray-900/50 rounded-xl p-4 flex items-center justify-center gap-6 flex-wrap border border-gray-100 dark:border-gray-700 transition-colors">
            {/* Sport Type Dropdown */}
            <div className="flex items-center gap-2">
                <select
                    ...
                    disabled={loading}
                    className="border border-green-600 dark:border-green-500 text-green-600 dark:text-green-400 bg-white dark:bg-gray-700 px-4 py-2 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/30 transition focus:outline-none focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 min-w-[150px]"
                >
