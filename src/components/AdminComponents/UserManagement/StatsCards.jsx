...
const StatsCards = ({ displayStats }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
      {cards.map((card, i) => (
        <div key={i} className="bg-white dark:bg-gray-800 shadow dark:shadow-gray-900/50 rounded-2xl p-4 flex flex-col items-center border border-gray-200 dark:border-gray-700 transition-colors">
          {card.icon}
