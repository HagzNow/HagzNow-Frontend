    ...
    <div className="space-y-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/50 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
      ...
      <div className="p-6 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">تفاصيل الحجز</h2>
            <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">مراجعة معلومات حجزك</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 border border-gray-200 dark:border-gray-600 hover:border-green-300 dark:hover:border-green-500 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h4 className="font-semibold text-gray-900 dark:text-white text-lg">{dayName}</h4>
          ...
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 border border-gray-200 dark:border-gray-600 hover:border-green-300 dark:hover:border-green-500 transition-colors duration-300">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">الوقت</p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 border border-gray-200 dark:border-gray-600 hover:border-green-300 dark:hover:border-green-500 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">المدة</p>
                <h4 className="font-semibold text-gray-900 dark:text-white text-lg">
                  {slots.length} {slots.length === 1 ? 'ساعة' : 'ساعات'}
                </h4>
                <p className="text-gray-600 dark:text-gray-300 text-sm">({slots.length * 60} دقيقة)</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 border border-gray-200 dark:border-gray-600 hover:border-green-300 dark:hover:border-green-500 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h4 className="font-semibold text-gray-900 dark:text-white text-lg">محفظة التطبيق</h4>
                <p className="text-gray-600 dark:text-gray-300 text-sm">دفع آمن ومضمون</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 border border-gray-200 dark:border-gray-600 hover:border-green-300 dark:hover:border-green-500 transition-colors duration-300">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">الخدمات الإضافية</p>
              {selectedExtras?.length > 0 ? (
                  ...
                  {selectedExtras.map((extra) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="font-medium text-gray-800 dark:text-gray-200">{extra.name}</span>
                        <span className="font-semibold text-green-600 dark:text-green-400">
                          {extra.price} <span className="text-sm text-gray-500 dark:text-gray-400">ج.م</span>
                        </span>
                      </div>
                    </div>
                  ))}
                ...
                <div className="text-center py-4">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">لا توجد إضافات مختارة</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 border border-gray-200 dark:border-gray-600 hover:border-green-300 dark:hover:border-green-500 transition-colors duration-300">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">موقع الملعب</p>
              <h4 className="font-semibold text-gray-900 dark:text-white">{arena?.location?.city}</h4>
              <p className="text-gray-600 dark:text-gray-300 text-sm">{arena?.location?.governorate}</p>
            </div>
          </div>
        </div>
