      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-green-50 dark:text-green-100 mb-8 max-w-2xl mx-auto leading-relaxed">
            {t('cta_description') ||
              'انضم إلى آلاف المستخدمين الذين يثقون بنا لحجز ملاعبهم المفضلة. ابدأ الآن واستمتع بأفضل تجربة حجز.'}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <PWAInstallButton
              variant="button"
              className="px-8 py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 bg-white dark:bg-gray-800 text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-gray-700 border-2 border-white/30 dark:border-white/20 h-auto min-h-[3rem] flex items-center"
              showAlways={true}
            />
          </div>
